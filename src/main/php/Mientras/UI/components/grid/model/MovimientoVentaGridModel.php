...
//		//TODO esto setearlo en el .rasty
	...
	public function getHeaderContent(){
		...
		return 'Bruto: <strong>'.MientrasUIUtils::formatMontoToView($service->getTotales($criteria)).'</strong> Neto: <strong>'.MientrasUIUtils::formatMontoToView($service->getGanancias($criteria)).'</strong>';
	}

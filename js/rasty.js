...
function openAddentityPopup(webpath, formType, fCallback, resultId, initialText, title, extraParams, height, width, popupDivId, formAction){
	...
	var url = webpath + "AddPopup.rasty?initialText=" + encodeURI(initialText) + "&formType=" + formType + "&popupDivId=" + popupDivId + "&onSuccessCallback=" + fCallback + "&" + extraParams+ "&formAction=" + encodeURI(formAction);
